...
function get_table_data(){
			...
			$.ajax({
				url: "../backbone/controller/getStudentBooks.php",
				type: "POST",
				data: 'getBooks',
				dataType: 'json',
				beforeSend: function(){
		...
		function manage_data(data){
			...
			$.each(data, function(key, value){
				...
				row += '<div class="card" >'; 
				row += '<img class="card-img-top" src="'+ value.imgFileName +'" height="200px" width="1000px" alt="">'; 
				row += '<div class="card-body">'; 
				row += '<h5 class="card-title">'+ value.bookTitle +'</h5>';
				row += '<p>'+ value.author +'</p>' ;
				row += '</div>';
				row += '<div class="card-footer" data-id="'+ value.id +'" > '; 
				row += '<button type="button" id="approve" class="btn btn-success" data-toggle="modal" data-target=".bs-example-modal-lg">View Book</button> '; 
				row += '</div>';
				row += '</div>';
				row += '</div>';
			});
			...
			// <img class="card-img-top" src="<?php echo BASE_URL; ?>assets/img/book.jpg" alt="">
   //          <div class="card-body">
   //            <h5 class="card-title">Advances in Mobile Cloud Computing Systems</h5>
   //            <p>F. Richard Yu</p>
   //          </div>
   //          <div class="card-footer">
   //            <a href="#" class="btn btn-success" data-toggle="modal" data-target=".bs-example-modal-lg">View Book</a>
   //          </div>
